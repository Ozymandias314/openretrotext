...
from models.localtext_model.get_edit import write_edits
from models.localtext_model.LocalTemplate.template_decoder import read_prediction, decode_localtemplate
from models.localtext_model.model import LocalText
from models.localtext_model.utils import load_dataloader
...
class LocalTextPredictor:
    """Class for LocalText Predicting"""
    ...
    def build_test_model(self):
        ...
        checkpoint = os.path.join(self.model_path, "LocalText.pth")
    ...
    def get_raw_predictions(self):
        ...
        test_loader = load_dataloader(self.model_args, self.encoder_tokenizer)
    ...
    def compile_into_csv(self):
        ...
        with open(output_file, "w") as of:
            ...
            for result in tqdm(p.imap(get_k_predictions, tasks),
                               ...
                               desc="Decoding LocalText predictions and compiling into predictions.csv"):
