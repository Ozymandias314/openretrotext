...
class LocalTextHandler:
    """LocalText Handler for torchserve"""
    ...
    def initialize(self, context):
        ...
        checkpoint = os.path.join(model_dir, "LocalText.pth")
    ...
    def inference(self, data: List[str]):
        from models.localtext_model.get_edit import combined_edit, get_bg_partition
