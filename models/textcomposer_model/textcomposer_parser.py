...
def add_preprocess_opts(parser):
    ...
    group = parser.add_argument_group("textcomposer_preprocess")
...
def add_train_opts(parser):
    ...
    group.add("--epochs", help="no. of training epochs", type=int, default=1)
    group.add("--lr", type=float, default=0.00004, help='learning rate (default: 0.0003)')
...
def add_predict_opts(parser):
    """Predicting options"""
    group = parser.add_argument_group("textcomposer_predict")
