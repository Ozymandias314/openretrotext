...
from models.textcomposer_model.textreact_utils import expand_position_embeddings
...
class GNN_graphpred(torch.nn.Module):
    ...
    def __init__(self, num_layer, emb_dim, atom_feat_dim, bond_feat_dim, center_loss_type, fusion_function,
                 prod_word_size, react_word_size, encoder_path, max_length, JK="last", drop_ratio=0, graph_pooling="mean"):
        ...
        self.encoder_project = nn.Linear(768, 300)
    ...
    def forward(self, batch, input_ids, attention_mask, typed=False, decode=False, beam_size=1):
        ...
        text_feats_projected = self.encoder_project(text_feats)
        
        node_representation, graph_representation = self.run_gnn(batch, typed)

        graph_representation = graph_representation + text_feats_projected
