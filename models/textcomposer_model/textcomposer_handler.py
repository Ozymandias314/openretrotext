...
class TextComposerHandler:
    """TextComposer Handler for torchserve"""
    ...
    def match_template_for_prediction(self, product_smi: str) -> Dict[str, Any]:
        from models.textcomposer_model.chemutils import get_pattern_fingerprint_bitstr
    ...
    def inference(self, data: List[Dict[str, Any]]):
        ...
        from models.textcomposer_model.prepare_mol_graph import mol_to_graph_data_obj
        from utils.chem_utils import canonicalize_smiles
