...
from models.textcomposer_model.chemutils import canonicalize_rxn
from models.textcomposer_model.chemutils import cano_smiles, cano_smiles_, cano_smarts, cano_smarts_
from models.textcomposer_model.chemutils import smarts_to_cano_smiles, get_pattern_fingerprint_bitstr
...
def get_tpl(task):
    idx, react, prod, id, cls, nn_id = task
    ...
    return idx, react, prod, reaction_smarts, cano_react, retro_okay_list, id, cls, nn_id
